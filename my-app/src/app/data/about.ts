...
export const aboutData: AboutInfo[] = [
  ...
  },
  {
    ...
    fullContent: 'The "KL Chitramela" is being orchestrated by the KL University\'s Student Activity Center, known as "KL SAC Film Technology Club." This student-led organization receives support from the Student Activity Centre (SAC) at KL University. KL Cinemalu is a hub for young and aspiring talents who share a deep passion for the world of cinema and filmmaking. Having already made a mark with their notable achievements such as short films and cover songs, KL Cinemalu has garnered significant acclaim from diverse audiences. The primary objective behind organizing the "KL Chitramela" is to foster and empower students who share a fervent enthusiasm for filmmaking. This event will feature a variety of inter-campus and intra-campus filmmaking competitions to inspire and engage these passionate individuals further.',
  },
];
